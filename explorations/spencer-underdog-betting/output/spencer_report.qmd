---
title: "Did Betting Early-Season Underdogs Ever Actually Work?"
subtitle: "A public-data test of Spencer's betting theory"
author: "Codex"
date: "2026-04-09"
format:
  pdf:
...
games across `44` league-seasons.
...
not large enough to become a dependable positive betting edge once bookmaker
hold and sampling uncertainty are accounted for.

![ROI by league and window](fig_roi_by_window.png)
...
slightly negative pooled mean, which is what you would expect if the league
splits contain some signal but also a lot of noise.

![League-specific estimates](fig_forest_plot.png)
...
![Calibration plot](fig_calibration.png)
...
The most interesting refined variant was focusing on bigger underdogs in the
first 3 weeks:
...
That mechanism is plausible, but the observed data look like only a small
version of it. The simulation supports the theory's logic more than it supports
a claim of large historical profits.

## Bottom line

Spencer's strategy was plausible, and the historical record suggests it was
directionally smarter than betting underdogs indiscriminately all year. But the
evidence does not justify a strong historical claim that betting early-season
